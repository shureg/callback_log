...
silent only
cd ~/Projects/callback_log/include
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +19 CallbackLog.class.h
badd +0 ~/Projects/callback_log/lib/CallbackLog.class.cc
badd +21 FileCallbackLog.class.h
badd +0 ~/Projects/callback_log/lib/FileCallbackLog.class.cc
badd +1 LOG.h
badd +17 ~/Projects/callback_log/lib/LOG.cc
badd +1 ~/Projects/callback_log/Makefile
badd +4 ~/Projects/callback_log/project.config.mk
badd +1 ~/Projects/callback_log/lib/Makefile
badd +0 ~/Projects/callback_log/lib/lib.config.mk
args CallbackLog.class.h
edit ~/Projects/callback_log/lib/CallbackLog.class.cc
...
19
normal! 016l
lcd ~/Projects/callback_log/lib
wincmd w
argglobal
edit ~/Projects/callback_log/include/CallbackLog.class.h
let s:cpo_save=&cpo
set cpo&vim
imap <buffer> <silent> <S-F2> :A
imap <buffer> <silent> <S-F9> :call C_Arguments()
...
19
normal! 0
lcd ~/Projects/callback_log/include
wincmd w
exe 'vert 1resize ' . ((&columns * 88 + 88) / 177)
exe 'vert 2resize ' . ((&columns * 88 + 88) / 177)
tabedit ~/Projects/callback_log/lib/FileCallbackLog.class.cc
set splitbelow splitright
wincmd _ | wincmd |
vsplit
1wincmd h
...
wincmd w
argglobal
edit ~/Projects/callback_log/include/FileCallbackLog.class.h
let s:cpo_save=&cpo
set cpo&vim
imap <buffer> <silent> <S-F2> :A
imap <buffer> <silent> <S-F9> :call C_Arguments()
...
exe 'vert 1resize ' . ((&columns * 88 + 88) / 177)
exe 'vert 2resize ' . ((&columns * 88 + 88) / 177)
tabedit ~/Projects/callback_log/lib/LOG.cc
set splitbelow splitright
wincmd _ | wincmd |
vsplit
1wincmd h
...
wincmd w
argglobal
edit ~/Projects/callback_log/include/LOG.h
let s:cpo_save=&cpo
set cpo&vim
imap <buffer> <silent> <S-F2> :A
imap <buffer> <silent> <S-F9> :call C_Arguments()
...
exe 'vert 1resize ' . ((&columns * 88 + 88) / 177)
exe 'vert 2resize ' . ((&columns * 88 + 88) / 177)
tabedit ~/Projects/callback_log/project.config.mk
set splitbelow splitright
wincmd _ | wincmd |
split
1wincmd k
...
12
normal! 024l
lcd ~/Projects/callback_log
wincmd w
argglobal
edit ~/Projects/callback_log/Makefile
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal balloonexpr=
...
exe '1resize ' . ((&lines * 20 + 22) / 44)
exe '2resize ' . ((&lines * 20 + 22) / 44)
tabedit ~/Projects/callback_log/lib/lib.config.mk
set splitbelow splitright
wincmd _ | wincmd |
split
1wincmd k
...
wincmd w
argglobal
edit ~/Projects/callback_log/lib/Makefile
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal balloonexpr=
